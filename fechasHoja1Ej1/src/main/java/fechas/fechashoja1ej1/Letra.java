...
public class Letra {
  ...
  public void mostrar() {
    ...
    System.out.println("Fecha de vencimiento: " + this.fechaVencimiento.toString());
    if(!vencida()) System.out.println("Dias para que venza: "+diasFaltan());
  }

  // Método que devuelve el mes de la letra
  public int devuelveMes() {
    return this.fechaVencimiento.getMonthValue();
  }
