    ...
    public static void main(String[] args) {              
        ...
        do{
            ...
            switch (opcion) {
                ...
                case 2 ->arr.introducir();
                
                case 3 ->System.out.println("LA MEDIA ES: "+arr.media());
                
                case 4 ->{System.out.println("SELECIONA LA POSICION A MODIFICAR");
                ...
                case 5 -> arr.rotarIzquierda();
                
                case 6 -> arr.rotarDerecha();
                
                case 7 -> {a.introducir();
                           arr.comparar(a);}
                
                case 8 -> arr.sumaPares();
                
                case 9 -> {System.out.println("INTRODUCE EL NUMERO PARA RELLENA CON SUS MULTIPLOS");
